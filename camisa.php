    ...
    <!-- Resto del código del formulario -->
      ...
      <section class="banner_main">
         <div id="banner1" class="carousel slide" data-ride="carousel">
            ...
            <div class="text-bg">
               <h1 style="color:#ffffff; font-size:3em"> CAMISA</h1>
            </div>
            <div>
<section>
   <section class="junto">
      <section class="producto">
          <div class="displayed-image-container">
              <img id="displayedImage" src="images/camisa1.png" alt="Imagen Predeterminada">
           ...
           <section class="producto" style="color:#ffffff; font-size:1.5em;">
            <section style="color:rgb(255, 255, 255); font-size:1.5em;"> SELECCIONA EL COLOR<br> 
               <button class="color-button-gris" onclick="showImage('images/camisa1.png')"></button>
               <button class="color-button-rojo" onclick="showImage('images/camisa2.png')"></button>
               <button class="color-button-rosa" onclick="showImage('images/camisa3.png')"></button>
               <button class="color-button-morado" onclick="showImage('images/camisa4.png')"></button>
               <button class="color-button-tinto" onclick="showImage('images/camisa5.png')"></button>
               <button class="color-button-verde" onclick="showImage('images/camisa6.png')"></button>
               <button class="color-button-azul" onclick="showImage('images/camisa7.png')"></button>
               <button class="color-button-blanco" onclick="showImage('images/camisa8.png')"></button>
               <section style="color:#ffffff; font-size:1em;">DESCRIPCIÓN</section>
            <div style="font-size:0.5em">La camisa es una prenda esencial y versátil, con diferentes estilos que se adaptan a diversas ocasiones y preferencias personales. Desde la camisa formal de negocios hasta la camiseta casual, esta prenda es un elemento básico en cualquier guardarropa.</div>
               <section style="color:rgb(255, 255, 255); font-size:1em;">PRECIO:</section><a style="color:aquamarine">$149.99 MXN </a>
